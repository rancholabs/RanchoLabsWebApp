...
import { INSTRUCTOR_INFO_REQUEST, INSTRUCTOR_INFO_SUCCESS, INSTRUCTOR_INFO_FAIL, INSTRUCTOR_SCHEDULE_FAIL, INSTRUCTOR_SCHEDULE_SUCCESS, INSTRUCTOR_SCHEDULE_REQUEST, INSTRUCTOR_BATCH_SUCCESS, INSTRUCTOR_NOTE, INSTRUCTOR_UPDATE_REQUEST, INSTRUCTOR_UPDATE_SUCCESS, INSTRUCTOR_UPDATE_FAIL, INSTRUCTOR_UPDATEBATCHCLASS_FAIL, INSTRUCTOR_UPDATEBATCHCLASS_SUCCESS, INSTRUCTOR_UPDATEBATCHCLASS_REQUEST, INSTRUCTOR_CLASSLINK_UPDATE_REQUEST, INSTRUCTOR_CLASSLINK_UPDATE_SUCCESS, INSTRUCTOR_CLASSLINK_UPDATE_FAIL } from '../Constants/Instructor'
...
export const instructorSchedule = (date, batch) => async (dispatch, getState) => {
  try {
    dispatch({
...
export const instructorUpdateBatchClass = (update, batchId, classId)  => async (dispatch, getState) => {
  try {
    dispatch({
...
export const updateClassLink = (updates, classId) => async(dispatch, getState) => {
  dispatch({
...
export const instructorNote = (note) => (dispatch) => {
  dispatch({ 
    type: INSTRUCTOR_NOTE, payload: note 
  })
