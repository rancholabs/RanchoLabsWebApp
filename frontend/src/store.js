...
import {
  dashboardReducer,
  dashboardActiveCourseReducer,
  journeycourseReducer,
} from "./Reducers/dashboardReducers";
import {
  coursegroupReducer,
  courseGroupsListReducer,
...
import {
  ...
  studentInfoReducer,
  studentFreeEnrollUpdateReducer,
} from "./Reducers/Student";
import { sendMailReducer } from "./Reducers/userReducer";
import {
  instructorInfoReducer,
  instructorScheduleReducer,
  instructorBatchReducer,
  instructorNoteReducer,
...
let instructorNote;
try {
  instructorNote = localStorage.getItem("instructorNote")
    ? JSON.parse(localStorage.getItem("instructorNote"))
    : null;
} catch (e) {
  instructorNote = null;
}
...
const initialState = {
  ...
  appDetails: {
    appName: "RANCHO LABS",
    author: {
      authorName: "Gokulnath B",
      authorLink: "http://gokulnathb.dx.am",
    },
  },
