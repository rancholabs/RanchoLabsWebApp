...
const FreeClass = ({location}) => {
    ...
    const loginfor = location && location.search ? location.search.split('loginfor=')[1] : null
    ...
    useEffect(() => {
        if(userInfo) {
            ...
            dispatch(updateStudent({parentDetails, grade, loginfor, freeEnrollment}))
        }
    }, [userInfo])

    const submitHandler = (e) => {
        e.preventDefault()
        if(email ==="" || name==="" || pname === "" || contact === "" || pemail === "" || pdialcode === "")	
        {	
    ...
    useEffect(()=>{
        dispatch(updateHeader({backgroundColor: '#171636', color: '#FFFFFF', iconColor: '#3CFAFF', iconDisplay: 'block', headerDisplay: 'block'}))
    ...
    return(
        ...
        <div className="freeclass row mx-0">
            <div className="freeclass-content">
                ...
                <div className="freeclass-desc">Sharing the same vision with you to take a step towards the future of 
                automation, programming, coding and robotics.</div>
            </div>
                ...
                <form>
                    ...
                    <div className="p-name">
                        <div className="row mx-0">
                            <div className="input-icon"><Fontawesome name="user" /></div>
                            <input type="text" 
                            name="name" 
                    ...
                    <div className="p-name">
                        <div className="row mx-0">
                            <div className="input-icon"><Fontawesome name="envelope" /></div>
                            <input type="text" 
                            name="email" 
                    ...
                    <div className="p-split">
                                <input list="pdialcodes" name="country-code"
                                    placeholder="+91"
                                    value={pdialcode}
                    ...
                    <p>Already Have an accout?<a href="/login"> Login </a> here</p>
                </form>
            </div>
        </div>
        </>
