  ...
  return (
    <div className="wws-card">
      ...
      <div className="wws-card-info">
        <div className="wws-card-title">
          <span className="">
            <CountUp end={props.title}>
              {({ countUpRef, start }) => (
  ...
  return (
    <div>
      <div className="aboutus-stand">
        ...
        <div className="wherewestand-desc">
          RanchoLabs keeps transforming the lives of students. With each day,
          our passion for teaching and problem solving only grows stronger.
        </div>
