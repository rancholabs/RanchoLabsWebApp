  ...
  return (
    <div>
      <div className="youngInnovator_header">
        ...
        <p>
          We are selecting 100 students from all over India based on their
          logical, algorithmic thinking capability and zeal towards innovation.{" "}
        </p>
      </div>
      ...
      <button
        ...
        onClick={() =>
          (window.location.href = "https://forms.gle/qWxhqvRL4w9yGaNg8 ")
        }
      >
        Apply Now
      </button>
