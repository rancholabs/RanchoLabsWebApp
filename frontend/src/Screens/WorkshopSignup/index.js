...
const FormComponent = (props) => {
  ...
  return (
    <form>
      <label for="location">
        FIRST NAME<span className="important-field">*</span>
      </label>
      <input
        type="text"
        name="fname"
      ...
      ></input>
      <label for="location">
        LAST NAME<span className="important-field">*</span>
      </label>
      <input
        type="text"
        name="email"
      ...
      ></input>
      <label for="email">
        EMAIL ADDRESS<span className="important-field">*</span>
      </label>
      <input
        type="text"
        name="email"
      ...
      {message ? (
        <p style={{ color: "#70707A", marginBottom: "0" }}>{message}</p>
      ) : (
        setMessage
      )}
      {isEmailExists ? (
        <p style={{ color: "#70707A", marginBottom: "0" }}>
          Seems like you already have an account with us. Please{" "}
