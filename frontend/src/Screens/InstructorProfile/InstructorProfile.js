...
const InstructorProfile = () => {
  ...
  const { loading, error, instructorInfo: instructor } = useSelector(
  ...
  const MessageHandler = () => {
    if (instructorMessage != "") {
      dispatch(
        sendMessage(instructor.name.first, instructor.email, instructorMessage)
      );
        ...
        <div className="row mx-0">
          <div>
            <div className="profile-logout text-center">
              <div className="profile-pic">
                <img
                  src={instructorProfileImage?.filePath}
                  id="instructor-pic"
                  alt=""
                />
                <input
                ...
                />
                <span id="profile-pic">
                  <Fontawesome name="camera"></Fontawesome>
                </span>
            ...
            <div className="profile-help">
              <div className="profile-help-top text-center">
                <Fontawesome
                  ...
                  style={{
                    marginRight: "calc(29*var(--vp))",
                    fontSize: "calc(32*var(--vp))",
                  }}
                />
                Need any Help?
              </div>
          ...
          <div className="personal-info">
            ...
            <form id="info">
              ...
              <label for="fname" style={{ marginTop: "calc(39*var(--vp))" }}>
                Contact Number
              </label>
              <div
                className="row mx-0"
              ...
              <label for="email" style={{ marginTop: "calc(25*var(--vp))" }}>
                Email Id
              </label>
              <input
                type="text"
              ...
              />
              <label for="password" style={{ marginTop: "calc(35*var(--vp))" }}>
                Reset Password
              </label>
              <div
                className="row mx-0"
                style={{
                  ...
                  marginTop: "calc(18*var(--vp))",
                  marginBottom: "calc(39*var(--vp))",
                  alignItems: "center",
                }}
              >
                <div>
                  <label for="new-password" style={{ marginBottom: "0" }}>
                    New Password
                  </label>
                </div>
                  ...
                  <div>
                    <label className="visibility d-flex align-items-center">
                      <input
                        type="checkbox"
                        onChange={() => {
                          document.getElementById("password").type = !vpassword
                            ? "text"
                            : "password";
              ...
              <div
                ...
                style={{
                  justifyContent: "space-between",
                  alignItems: "center",
                  marginBottom: "calc(45*var(--vp))",
                }}
              >
                <div>
                  <label for="repeat-password" style={{ marginBottom: "0" }}>
                    Repeat Password
                  </label>
                </div>
                <div className="row mx-0">
