...
import { UpdatePreviewSaveHandler, UpdatePreviewSteps } from '../../Actions/ProjectPreview'
import './css/ProjectSteps.css'

const ProjectSteps = () => {
    const {steps: sSteps} = useSelector((state) => state.projectPreview)
    ...
    const readImage = (image, id) => {
        readURL(image, `project-step-image-${id}`)
        return ''
    }
                                            ...
                                            <div>
                                                {s.image ? (
                                                    <>
                                                        ...
                                                        <img className="img" id={`project-step-image-${s.id}`} src={s.image.filePath ? s.image.filePath : typeof s.image === "object" ? readImage(s.image, s.id) : ''} />
                                                    </>
                                                ) : (
                                                    <>
