...
import { UpdatePreviewConclusion, UpdatePreviewSaveHandler } from '../../Actions/ProjectPreview'
import './css/ProjectComments.css'

const ProjectComments = () => {
    const {conclusion} = useSelector((state) => state.projectPreview)
    ...
    const readImage = (image, id) => {
        readURL(image, `project-comment-image-${id}`)
        return ''
    }
                                            ...
                                            <div>
                                                {c.image ? (
                                                    <>
                                                        ...
                                                        <img className="img" id={`project-comment-image-${c.id}`} src={c.image.filePath ? c.image.filePath : typeof c.image === "object" ? readImage(c.image, c.id) : ''} />
                                                    </>
                                                ) : (
                                                    <>
