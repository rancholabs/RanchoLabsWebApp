...
import { UpdatePreviewBrief, UpdatePreviewComponents, UpdatePreviewSaveHandler } from '../../Actions/ProjectPreview'
import './css/ProjectBrief.css'

const ProjectBrief = () => {
    const {brief: sBrief, components: sComponents} = useSelector((state) => state.projectPreview)
