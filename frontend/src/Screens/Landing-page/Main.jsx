...
const mainContent = {
    ...
    "Subheading": "Bringing 21st-century skills to help you become the next world tech leader",
}
...
function Content() {
    ...
    useEffect(() => {
        dispatch(updateHeader({ backgroundColor: '#ffffff', color: '#FFFFFF', iconColor: '#3cfaff' }))
    }, [])
        ...
        <div className="home main-content">
            ...
            <div className="container">
                ...
                <div className="buttons row mx-0">
                    <div className="sign-up"><a><button onClick={freeclasshandler}>FREE CLASS</button></a></div>
                    <div className="labtour"><a href="/aboutUs"><button>EXPLORE</button></a></div>
                </div>
            </div>
        </div>
    )
