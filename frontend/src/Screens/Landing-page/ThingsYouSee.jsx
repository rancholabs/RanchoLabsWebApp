...
function StudentExp(testimony){
    return(
        <div className="studentexp">
                ...
                <div className="studentimg"><img src={testimony.img}  alt = {testimony.name}/></div>
                <div className="studentdetails">
                {testimony.name} <br></br>{testimony.class}<br></br> {testimony.school}
                </div>
...
function Things(){
    return (
        <div className="things">
            ...
            <p>Our happy Students and Parents <br/><span id="heart"><FontAwesome name="heart"></FontAwesome></span></p>
