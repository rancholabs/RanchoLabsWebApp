...
const CardData = [
     { "coursename" : "Robotics",
        "tag" : "EASY PEASY",
        "Title": "Robotics",
        "Description" : "Build a strong foundation in Robotics & Drone building by learning coding, different electrical and mechanical concepts and mechanisms.",
        "style1" : customStyle,
        "style2" : {
            width: "100%",
            height: "125%",
    ...
    { "coursename" : "Programming",
        "tag" : "BRAINIAC",
        "Title":"Programming",
        "Description" : "Learn logic and structure to command tech tools and generate outcomes like games and apps. Either side of the brain works and balances with Coding. It offers creativity plus intelligence.",
        "style1" : customStyle2,
        "style2" :{
            width: "100%",
            height: "125%",
    ...
    {"coursename" : "Artificial Intelligence",
        ...
        "Description" : "Look forward to solve some real life problems with machines enabled with human intelligence. AI is intelligence demonstrated by machine, unlike the natural human intelligence.",
        "style1" : customStyle,
        "style2" :  {
            width: "80%",
            height: "100%",
...
function OuterCard(props){
    ...
    return (
        <div className="card outer">
            ...
            <div className="btn learnmore" onClick={() => onclickHandler(props.groupId)}>Learn More</div>
            </div>
        </div>
    )
}
...
function MobileCard(props){
    ...
    return(
        <div className = "mobilecard">
            <div className="card">
                <img className="card-img-top" src={props.imgmob} alt={props.coursename}></img>
                <div className="card-body">
                <div className="card-coursename">{props.tag}</div>
                <div className="card-title">{props.coursename}</div>
                <div className="card-text">{props.Description}</div>
                <center><div className="btn learnmore" onClick={() => onclickHandler(props.groupId)}>Learn More</div></center>
                </div>
            </div>
        </div>
    )
