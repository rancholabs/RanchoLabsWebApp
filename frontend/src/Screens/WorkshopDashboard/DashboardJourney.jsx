...
const DStepcards = (props) => {
    return(
        <>
                ...
                <div className="row mx-0" style={{justifyContent:"space-evenly", width:"100%"}}>
                {
...
const DashboardJourney = () => {
    ...
    const selected = courseGroups.filter((course)=>{
        if(course.name === JourneyCourse.journeycourse)
        return course
    })
    ...
    return(
        ...
        <div className="dashboardjourney">
            <div className="row mx-0 dj">
                ...
                <div className="dashboard-journey-title">My Journey Path for <span>{JourneyCourse.journeycourse}</span></div>
                <Dropdown>
                    ...
                    <Dropdown.Menu>
                        {
                            courseGroups.map((group) =>
                                <>
                                    <Dropdown.Item onClick={() => selectGroup(group.name)}>{group.name}</Dropdown.Item>
                                </>
                            )
                        }
                    </Dropdown.Menu>
