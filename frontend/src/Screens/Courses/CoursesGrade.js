...
const CourseGradeItem = ({grade, isActive, clickHandler}) => {
    ...
    return (
        ...
        >
            <div className="text">GRADE {minG} - {maxG}</div>
        </div>
    )
}
...
const CoursesGrade = ({grades, activeGrade, setActiveGrade}) => {
    ...
    return (
        <div className="courses-grade">
            <div className="title">SELECT GRADE</div>
            <div className="grades">
                {
                    ...
                    .map((grade, gi) => {
                        return (
                            <CourseGradeItem
                                key={gi}
                                isActive={activeGrade && (grade.minG === activeGrade.minG && grade.maxG === activeGrade.maxG)}  
                                grade={grade}
