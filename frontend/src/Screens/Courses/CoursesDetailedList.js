...
const CoursesDetailedListItem = ({
  ...
  return (
    <div
      className={`courses-detailed-list-item${isActive ? " active" : ""}`}
      onClick={() => (!isActive ? clickHandler(courseGroup, parentIndex) : "")}
    >
      <div className="img">
...
const CoursesDetailedList = ({ courseGroups, activeCourseG, activeGrade }) => {
  ...
  const [toBeDisplayedCourses, settoBeDisplayedCourses] = useState([]);
  ...
  return (
    <div className="courses-detailed-lists">
      ...
      {/* {activeCourseGroup && activeCourseGroup.index === sci && ( */}
      {/* <CoursesDetailedListCards */}
      {/* coursesDetails={activeCourseGroup.courseGroup.courses} */}
      {/* /> */}
      {/* )} */}
      {/* </div> */}
      {/* ); */}
