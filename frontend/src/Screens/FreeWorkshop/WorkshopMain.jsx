        ...
        <div className="WorkshopMain">
            <div className="row">
                <div className="col-md-7">
                    <div className="Workshop-title">Robotics- Free Workshop</div>
                    <div className="Workshop-subtitle">A free workshop in Robotics for school students, <span id="IITians">by IITians</span></div>
                    ...
                    <a href="#batches"><div className="btn enroll">ENROLL NOW</div></a>
                </div>
            ...
            <div className="Workshop-info">
                <div className="row">
                    <div className="col-md-6">
                        ...
                        <div className="info-content">You will learn about many electrical components, connecting and communicating
                        with different devices, programming them to do the required task. This workshop will introduce you to the
                         field of Robotics and its core branches like Mechanical, Electrical and Programming.</div>
                    </div>
                </div>
            </div>
        </div>
